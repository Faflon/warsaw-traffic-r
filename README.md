...
### Architecture overview
    ...
    GTFS schedule (ZTM)
      └─ build_route_shapes()                 # one-time preprocessing
           └─ inst/extdata/warsaw_routes.rds  # sf LINESTRING per route, EPSG:2180, loaded once on startup
...
whose physical path crosses the disrupted area are returned as
affected - a crash on a highway does not flag a bus running on a
parallel local road.
